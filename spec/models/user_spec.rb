...
describe User do
  ...
  describe "micropost associations" do
    ...
    it "should destroy asociated microposts" do
      @user.destroy
  ...
  describe "relationships" do
    ...
    it "should followed another user" do
      @user.follow!(@followed)
    ...
    it "should have an unfollowed! method" do
    ...
    it "should have the reverse relationship method" do
